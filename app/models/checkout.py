"""
Equipment checkout system for tracking equipment location and status.
"""
import os
import pandas as pd
import json
...
class CheckoutManager:
    """Manages equipment checkout, location tracking, and status."""
    ...
    def _save_checkout_history(self):
        ...
        with open(self.checkout_history_file, 'w') as f:
            json.dump(self.checkout_history, f, indent=2)
    ...
    def _save_equipment_status(self):
        ...
        with open(self.equipment_status_file, 'w') as f:
